...
function Xd(data) {
  ...
  this.grid = [];     // [y][x]
  this.flags = [];     // [y][x]
  this.clues = [];    // [[direction, num], clue, answer]
  this.notes = "";
  this.number_index = [];
  var self = this;

  /*
   * Parse an XD file.  This is copied from the
   * original python source in order to ensure
   * compatibility.
   */
  ...
  /*
   * Randomly generate a "puzzle.js" format object, compatible with
   * crossword.js.
   */
